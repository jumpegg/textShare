System.config({
    ...
    map: {
        ...
        '@angular/platform-browser/animations' : 'npm/platform-browser/bundles/platform-browser-animations.umd.js',
        '@angular/router': 'npm/router/bundles/router.umd.js',
        '@angular/animations':'npm/animations/bundles/animations.umd.min.js',
        '@angular/animations/browser':'npm/animations/bundles/animations-browser.umd.js',
